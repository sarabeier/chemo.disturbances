...
Dat=data.frame(read_xls("../data/comm.rates/MicrobialAbundance.xls",sheet="Chemo summary"))
...
```{r,include=FALSE}
# Setup figures
pBP=pBP+theme(plot.margin=margin(t = -5, r = 5, b = -22, l = 0, unit = "pt"))+
  labs(tag = "A")+theme(plot.tag=element_text(size=14,face="bold",vjust=-4))

pR=pR+theme(plot.margin=margin(t = -5, r = 5, b = -22, l = 0, unit = "pt"))+
  labs(tag = "B")+theme(plot.tag=element_text(size=14,face="bold",vjust=-4))

pBGE=pBGE+theme(plot.margin=margin(t = -5, r = 5, b = -22, l = 0, unit = "pt"))+
