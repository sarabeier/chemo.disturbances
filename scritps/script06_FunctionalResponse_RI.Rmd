...
```{r,include=FALSE}
# Setup figures
pBP=pBP+theme(plot.margin=margin(t = -6, r = 5, b = -21.3, l = 0, unit = "pt"))+
  labs(tag = "")+theme(plot.tag=element_text(size=14,face="bold",vjust=-4))

pR=pR+theme(plot.margin=margin(t = -6, r = 5, b = -21.3, l = 0, unit = "pt"))+
  labs(tag = "")+theme(plot.tag=element_text(size=14,face="bold",vjust=-4))

pBGE=pBGE+theme(plot.margin=margin(t = -6, r = 5, b = -21.3, l = 0, unit = "pt"))+
  labs(tag = "")+theme(plot.tag=element_text(size=14,face="bold",vjust=-4))
```
