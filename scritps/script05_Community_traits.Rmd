...
bxp=tag_facet(bxp,open = "", close = "",
              tag_pool=c(" A) RNN", " B) RNN "," C) Minimal generation time (hrs)"," D) Minimal generation time (hrs)"," E) TF (%)"," F) TF (%)"," G) Genome Size (Mbp)", " H) Genome Size (Mbp)"," I) Shannon"," J) Shannon"),x=0, fontface = 1,size=3,hjust=0)
